...
function calculateItemPrice(index) {
  return (
    (parseInt(filterFoods.value[index].food_price) -
      parseInt(filterFoods.value[index].food_discount)) *
    itemQuantity.value[index]
  ).toString();
}
...
async function onQtyChange(e, i) {
  ...
  let data = {
    ...
    food_id: parseInt(cartItem.value[i]),
    item_qty: itemQuantity.value[i],
  };
  await AxiosInstance.put("/cartItem/", data);
}
async function cancelBtn() {
  await AxiosInstance.delete("/cartItem/" + user.value.user_id);
  cartItem.value = [];
  itemQuantity.value = [];
}
async function removeBtn(index) {
  await AxiosInstance.delete(
    "/cartItem/" + user.value.user_id + "/" + cartItem.value[index]
  );
          ...
          <div class="col-md-3">
            ...
            <div class="box">
              ...
              <div class="box-content text-center">
                <h3><i class="fa fa-phone"></i> +212 123 123 123</h3>
                <span class="small">
